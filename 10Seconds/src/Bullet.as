package  
{
	...
	public class Bullet extends FlxSprite
	{
		...
		public function Bullet(text : String, destination : FlxPoint, width : int, fadeOutPos : FlxPoint, start : FlxPoint, fontSize : int, state : FlxState, color : uint, speedIn : int = 200, speedOut : int = 200, endScale : int = 60, right : Boolean = true) 
		{
